...
struct Day07: Day {
    ...
    private func generateExpressions(numbers: [String], operators: [String]) -> [[String]] {
        if numbers.count == 1 {
            return [numbers]
        }
    ...
    private func evaluateExpressions(expressions: [[String]], result: Int) -> Int? {
